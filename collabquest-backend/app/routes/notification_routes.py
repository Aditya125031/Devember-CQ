...
async def mark_all_read(current_user: User = Depends(get_current_user)):
    """
    Marks ALL unread notifications as read so the badge count resets.
    Actionable notifications remain actionable, but no longer contribute to the unread count.
    """
