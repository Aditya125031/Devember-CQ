...
export default function SignupPage() {
  ...
  <a
    ...
    className="flex-1 flex items-center justify-center gap-2 py-3 bg-[#121212] hover:bg-[#1A1A1A] border border-white/10 rounded-xl transition-all duration-200 group/btn"
  >
    <Github className="h-5 w-5 text-gray-400 group-hover/btn:text-white transition-colors" />
    <span className="text-sm font-bold text-gray-300 group-hover/btn:text-white">
      GitHub
    </span>
  </a>
